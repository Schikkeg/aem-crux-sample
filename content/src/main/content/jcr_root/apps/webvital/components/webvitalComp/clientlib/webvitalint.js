            ...
            $.ajax({
                ...
                if(	data.statusmessage !== undefined ){
					...
					if(JSON.stringify(jsonwvobj.PHONE) !== JSON.stringify({})){
						mobileWebVital = ' <div class="deviceScores"><div class="label">Mobile</div><div class="scores"><span>CLS:&nbsp;</span><span class="'+jsonwvobj.PHONE.CLSSTYLE+'">'+jsonwvobj.PHONE.CLS+'</span><span>&nbsp;FID:&nbsp;</span><span class="'+jsonwvobj.PHONE.FIDSTYLE+'">'+jsonwvobj.PHONE.FID+'</span><span>&nbsp;LCP:&nbsp;</span><span class="'+jsonwvobj.PHONE.LCPTYLE+'">'+jsonwvobj.PHONE.LCP+'</span></div></div>';
					 	allWebVital = '<div class="webvitals">' +mobileWebVital;
						firstOne = true;
                     }
					
                    if(JSON.stringify(jsonwvobj.DESKTOP) !== JSON.stringify({})){
						desktopWebVital = ' <div class="deviceScores"><div class="label">Desktop</div><div class="scores"><span>CLS:&nbsp;</span><span class="'+jsonwvobj.DESKTOP.CLSSTYLE+'">'+jsonwvobj.DESKTOP.CLS+'</span><span>&nbsp;FID:&nbsp;</span><span class="'+jsonwvobj.DESKTOP.FIDSTYLE+'">'+jsonwvobj.DESKTOP.FID+'</span><span>&nbsp;LCP:&nbsp;</span><span class="'+jsonwvobj.DESKTOP.LCPTYLE+'">'+jsonwvobj.DESKTOP.LCP+'</span></div></div>';
						if(firstOne){
							if(!showMore){
								if(moreAdded){
					...
					if(JSON.stringify(jsonwvobj.TABLET) !== JSON.stringify({})){
						tabletWebVital = ' <div class="deviceScores"><div class="label">Tablet</div><div class="scores"><span>CLS:&nbsp;</span><span class="'+jsonwvobj.TABLET.CLSSTYLE+'">'+jsonwvobj.TABLET.CLS+'</span><span>&nbsp;FID:&nbsp;</span><span class="'+jsonwvobj.TABLET.FIDSTYLE+'">'+jsonwvobj.TABLET.FID+'</span><span>&nbsp;LCP:&nbsp;</span><span class="'+jsonwvobj.TABLET.LCPTYLE+'">'+jsonwvobj.TABLET.LCP+'</span></div></div>';
						if(firstOne){
							if(!showMore){
								if(moreAdded){
                    ...
                    if(JSON.stringify(jsonwvobj.PHONE3G) !== JSON.stringify({})){
						mobile3gWebVital = ' <div class="deviceScores"><div class="label">PHONE3G</div><div class="scores"><span>CLS:&nbsp;</span><span class="'+jsonwvobj.PHONE3G.CLSSTYLE+'">'+jsonwvobj.PHONE3G.CLS+'</span><span>&nbsp;FID:&nbsp;</span><span class="'+jsonwvobj.PHONE3G.FIDSTYLE+'">'+jsonwvobj.PHONE3G.FID+'</span><span>&nbsp;LCP:&nbsp;</span><span class="'+jsonwvobj.PHONE3G.LCPTYLE+'">'+jsonwvobj.PHONE3G.LCP+'</span></div></div>';
						if(firstOne){
							if(!showMore){
								if(moreAdded){
                    ...
                    if(JSON.stringify(jsonwvobj.PHONE4G) !== JSON.stringify({})){
						mobile4gWebVital = ' <div class="deviceScores"><div class="label">PHONE4G</div><div class="scores"><span>CLS:&nbsp;</span><span class="'+jsonwvobj.PHONE4G.CLSSTYLE+'">'+jsonwvobj.PHONE4G.CLS+'</span><span>&nbsp;FID:&nbsp;</span><span class="'+jsonwvobj.PHONE4G.FIDSTYLE+'">'+jsonwvobj.PHONE4G.FID+'</span><span>&nbsp;LCP:&nbsp;</span><span class="'+jsonwvobj.PHONE4G.LCPTYLE+'">'+jsonwvobj.PHONE4G.LCP+'</span></div></div>';
						if(firstOne){
							if(!showMore){
								if(moreAdded){
					...
					if(JSON.stringify(jsonwvobj.ORIGINS) !== JSON.stringify({})){
						...
						for(var counter=0;counter<originVital.length;counter++){
                            ...
                            for (key in originObj){
                                ...
                                allWebVital = allWebVital + ' <span>CLS:&nbsp;</span><span class="'+displayScore.CLSSTYLE+'">'+displayScore.CLS+'</span><span>&nbsp;FID:&nbsp;</span><span class="'+displayScore.FIDSTYLE+'">'+displayScore.FID+'</span><span>&nbsp;LCP:&nbsp;</span><span class="'+displayScore.LCPTYLE+'">'+displayScore.LCP+'</span></div></div>';
